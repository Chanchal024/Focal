...
const Navbar = () => {
    ...
    return (
        ...
        <nav id="navbar" className="absolute top-4 left-1/2 z-50 w-[82%] max-w-5xl -translate-x-1/2">
            ...
            <div className="rounded-[5rem] border border-white/20 bg-white/10 px-6 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.25)] backdrop-blur-xl backdrop-saturate-150">
                <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="flex items-center">
                        <img src="/Focal.png" alt="FOCAL" className="h-10 w-auto object-contain" />
                    </a>
                    ...
                    <div className="hidden items-center gap-8 md:flex">
                        {navLinks.map((link) => (
                            <a
                                key={link.name}
                                href={link.href}
                                className="relative text-sm font-medium text-white transition duration-300 hover:text-white
                    ...
                    {/* CTA */}
                    <a href="#contact" className="hidden rounded-full bg-orange-400 px-5 py-2.5 text-sm font-semibold text-black md:block hover:bg-orange-300 transition-colors">
                        Let's Talk
                    </a>
                    ...
                    <div className="mt-5 border-t border-white/10 pt-5 md:hidden">
                        <div className="flex flex-col gap-4">
                            ...
                            <a
                                href="#contact"
                                onClick={() => setIsOpen(false)}
                                className="mt-2 rounded-xl bg-orange-400 px-4 py-3 text-center text-sm font-semibold text-black transition hover:bg-orange-300"
                            >
                                Let's Talk
                            </a>
                        </div>
